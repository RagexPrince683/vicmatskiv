...
public class G18Mag extends ModelBase
{
    ...
    public G18Mag() {
        ...
        (this.gun2 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 3, 18, 5);
        ...
        (this.gun5 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 1, 18, 5);
