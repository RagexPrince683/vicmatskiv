...
public class NATO20rnd extends ModelBase
{
    ...
    public NATO20rnd() {
        ...
        (this.gun2 = new ModelRenderer((ModelBase)this, 200, 0)).addBox(0.0f, 0.0f, 0.0f, 3, 6, 8);
        ...
        (this.gun5 = new ModelRenderer((ModelBase)this, 200, 0)).addBox(0.0f, 0.0f, 0.0f, 1, 2, 8);
        ...
        (this.gun6 = new ModelRenderer((ModelBase)this, 200, 0)).addBox(0.0f, 0.0f, 0.0f, 1, 2, 8);
        ...
        (this.gun7 = new ModelRenderer((ModelBase)this, 200, 0)).addBox(0.0f, 0.0f, 0.0f, 1, 2, 7);
        ...
        (this.gun10 = new ModelRenderer((ModelBase)this, 200, 0)).addBox(0.0f, 0.0f, 0.0f, 1, 1, 7);
        ...
        (this.gun12 = new ModelRenderer((ModelBase)this, 200, 0)).addBox(0.0f, 0.0f, 0.0f, 1, 2, 7);
        ...
        (this.gun14 = new ModelRenderer((ModelBase)this, 200, 0)).addBox(0.0f, 0.0f, 0.0f, 1, 1, 7);
