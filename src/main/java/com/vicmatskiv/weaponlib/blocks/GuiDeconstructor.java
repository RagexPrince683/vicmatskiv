...
public class GuiDeconstructor extends GuiContainer
{
    ...
    public GuiDeconstructor(final InventoryPlayer playerInventory, final World parWorld, final String parBlockName, final int parX, final int parY, final int parZ) {
        super((Container)new ContainerDeconstructor(playerInventory, parWorld, parX, parY, parZ));
    ...
    protected void drawGuiContainerForegroundLayer(final int par1, final int par2) {
        ...
        if (string != null) {
            final ContainerDeconstructor.State msgType = this.container.deconstructingState;
